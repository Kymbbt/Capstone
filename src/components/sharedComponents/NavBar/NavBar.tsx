...
import GiftIcon from '@mui/icons-material/LocalMall';  
import ChristmasTreeIcon from '@mui/icons-material/ShoppingCart';
...
export const NavBar = () => {
    ...
    const navLinks = [
        {
          ...
          },
          {
            ...
            icon: myAuth === 'true' ? <GiftIcon /> : <AssignmentIndIcon />,
            onClick: () => navigate(myAuth === 'true' ? '/shop' : '/auth'),
          },
          {
            text: myAuth === 'true' ? 'Cart' : '',
            icon: myAuth === 'true' ? <ChristmasTreeIcon /> : "",
    ...
    return (
        <Box sx={{ display: 'flex' }}>
          ...
          <Drawer sx={open ? navStyles.drawer : navStyles.hide} variant="persistent" anchor="left" open={open}>
